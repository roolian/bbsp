...
use Elementor\Core\Scheme\Typography as Scheme_Typography;
			...
			<div class="hotspot-container">
				<div class="hotspot-image-wrapper">
					<# if ( settings.list.length ) { #>
						...
						#>
							<div 
								class="elementor-repeater-item-{{ item._id }} hotspot-pin  hotspot-pin-{{ item._id }}" 
								data-toggle="popover" 
								data-content="{{ item.pin_text }}"
							>
